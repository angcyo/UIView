package com.angcyo.uiview.github.pickerview.lib;
...
import com.angcyo.uiview.github.pickerview.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.base_text_color_dark);
        textColorCenter = getResources().getColor(R.color.base_text_color);
        dividerColor = getResources().getColor(R.color.default_base_line);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.default_text_size16);
        customTextSize = true;//getResources().getBoolean(R.bool.pickerview_customTextSize);
        if (attrs != null) {
