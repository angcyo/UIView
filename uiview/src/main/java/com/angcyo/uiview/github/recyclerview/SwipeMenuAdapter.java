 ...
 */
package com.angcyo.uiview.github.recyclerview;
...
public abstract class SwipeMenuAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public final VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mSwipeMenuCreator != null) {
            SwipeMenuLayout swipeMenuLayout = (SwipeMenuLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout.base_swipe_menu_item_default, parent, false);
