 ...
 * Version: 1.0.0
 */
public class RSoftInputLayout2 extends ViewGroup {
    ...
    public RSoftInputLayout2(Context context) {
        super(context);
    }

    public RSoftInputLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RSoftInputLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RSoftInputLayout2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
