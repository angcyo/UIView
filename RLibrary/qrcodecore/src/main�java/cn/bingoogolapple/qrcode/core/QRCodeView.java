...
//    protected CameraTexturePreview mTexturePreview;
...
//        mTexturePreview = new CameraTexturePreview(getContext());
        ...
        addView(mPreview);
//        mTexturePreview.setId(R.id.bgaqrcode_camera_preview);
//        addView(mTexturePreview);
...
//        layoutParams.addRule(RelativeLayout.ALIGN_TOP, mTexturePreview.getId());
//        layoutParams.addRule(RelativeLayout.ALIGN_BOTTOM, mTexturePreview.getId());
...
//            mTexturePreview.setCamera(mCamera);
        } catch (Exception e) {
            if (mDelegate != null) {
...
//                mTexturePreview.stopCameraPreview();
                mPreview.setCamera(null);
//                mTexturePreview.setCamera(null);
                mCamera.release();
                mCamera = null;
            }
        } catch (Exception e) {
...
//        mTexturePreview.openFlashlight();
    }
...
//        mTexturePreview.closeFlashlight();
    }
