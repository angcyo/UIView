...
public class RExSoftInputLayout extends ViewGroup {
    ...
    public RExSoftInputLayout(Context context) {
        super(context);
    }

    public RExSoftInputLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RExSoftInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RExSoftInputLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
