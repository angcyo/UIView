 ...
 * Version: 1.0.0
 */
public class StickBehavior2<V extends View> extends CoordinatorLayout.Behavior<V> {
    View mTargetView;
    ...
    public StickBehavior2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        stickOffset = (int) (100 * density());
    }
    ...
    public boolean onMeasureChild(CoordinatorLayout parent, V child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        child.measure(View.MeasureSpec.makeMeasureSpec(parent.getMeasuredWidth(), View.MeasureSpec.EXACTLY),
                View.MeasureSpec.makeMeasureSpec(parent.getMeasuredHeight() - stickHeight - stickOffset, View.MeasureSpec.EXACTLY));
        return true;
    }
