...
public class ItemDragHelperCallback extends ItemTouchHelper.Callback {
    ...
    public ItemDragHelperCallback(OnDragCallback dragCallback) {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (manager instanceof GridLayoutManager || manager instanceof StaggeredGridLayoutManager) {
            ...
            if (mDragCallback != null) {
                if (mDragCallback.canDragDirs(viewHolder)) {
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder target) {
        ...
        if (mDragCallback != null) {
            if (!mDragCallback.canDragDirs(target)) {
                return false;
            }
        }
    ...
    public interface OnDragCallback {
        boolean canDragDirs(RecyclerView.ViewHolder viewHolder);
    }
}
